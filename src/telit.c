 ...
 *
 * telit.c: This file contains the ETSI 07.07 implementation required
 * 	to suport the Telit GSM modules.
 *
 ...
 *	B: Telit AT Commands Reference Guide, 80000ST10025a Rev. 1 - 26/10/06
 */
...
struct timeval TelTimeDefault = {
	.tv_sec = 0,
	.tv_usec = 2*100,
};

struct timeval TelTime20secs = {
	.tv_sec = 20,
	.tv_usec = 0,
};

struct timeval CallTimeDefault = {
	.tv_sec = 60,
};

/* The GCR elements containing the currently supported functionality:	*/

/* Telit set phone functionality:
 * Parameters:	0 - Minimum functionality. AT interface not accessible.
...
static GCR telit_cfun = {
	.cmd = 		"cfun=",
	.csz =		sizeof telit_cfun.cmd,
	.resp = 	"OK",
	.nrparams = 	1,
	.tv = 	&TelTimeDefault,
};
 ...
 */
static GCR telit_cpin = {
	.cmd = 	"at+cpin=",
	.csz =	sizeof telit_cpin.cmd+1, // +1 because of = 
	.resp = "OK",
	.resp = 	"READY",
...
/* Telit set default operator:						*/
GCR telit_SetDefaultOperator = {
	.cmd = 	"at+cops=0",
	.resp = "OK",
	.tv = {10, 0},
};
...
/* Telit set operator:						*/
GCR telit_SetOperator = {
	.cmd = 	"at+cops=%d",
	.resp = "OK",
	.tv = {10, 0},
};

/* Telit get fun operator:						*/
GCR telit_activate = {
	.cmd = 	"at+cfun?",
	.resp = "OK",
	.tv = {10, 0},
...
/*
 * telit:	The support for the Telits implementation of ETSI 07 
 */

struct etsi_07_07 telit = {		// The Full ETSI 7.07 Specification:
	.mgf = 		"telit",	// Manufacturer name
	.model =	"default",	// Model
	...
	.CFUN = &telit_cfun,	// +CFUN: Set Phone Funcs      8.2/p58
	.CPIN = &telit_cpin,	// +CPIN: Enter Pin            8.3/p59
