...
/*
 * generic:	Generic template for an implementation of ETSI 07 
 */

struct etsi_07_07 generic_modem = {  // The Full ETSI 7.07 Specification:
	.mgf = 		"generic",	// Manufacturer name
	.model =	"default",	// Model
	...
	.CFUN = NULL,	// +CFUN: Set Phone Funcs      8.2/p58
	.CPIN = NULL,	// +CPIN: Enter Pin            8.3/p59
